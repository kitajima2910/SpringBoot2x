...
public class ResultUtil<T> {
    ...
    public static <T> Result<T> errorWithMessCode(String msg, String messCode) {
        return new ResultUtil<T>().setErrorMsgCode(msg, messCode);
    }
    ...
    public Result<T> setErrorMsgCode(String msg, String messCode) {
        this.result.setSuccess(false);
        this.result.setMessage(msg);
        this.result.setMessageCode(messCode);
        this.result.setCode(500);
        return this.result;
    }
